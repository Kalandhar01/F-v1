...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      corners.forEach((corner, i) => {
        gsap.to(corner, {
          x: targetCornerPositionsRef.current![i].x - (gsap.getProperty(cursorRef.current!, 'x') as number),
          y: targetCornerPositionsRef.current![i].y - (gsap.getProperty(cursorRef.current!, 'y') as number),
          duration: 0.2,
          ease: 'power2.out',
        })
      })
